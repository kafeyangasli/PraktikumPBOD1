...
public class gui_B extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(gui_B.class.getName());
    DefaultListModel<String> listDLM;
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new gui_B().setVisible(true));
    }
